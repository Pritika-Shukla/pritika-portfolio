  ...
  return (
    <section id="skills" className="py-36 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        {/* Main radial gradient with darker shades */}
        <div className="absolute inset-0 bg-gradient-radial from-black via-[#12002a] to-[#0a0a23] opacity-95" />
        {/* Blurred blobs with darker colors */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-900/40 rounded-full filter blur-3xl animate-pulse-slow" />
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-blue-900/30 rounded-full filter blur-2xl animate-pulse-slower" />
        <div className="absolute top-1/2 right-1/2 w-72 h-72 bg-indigo-900/30 rounded-full filter blur-2xl animate-pulse" />
        {/* Animated gradient overlay with darker tones */}
        <div className="absolute inset-0 bg-gradient-to-tr from-zinc-900 via-[#1a003a]/40 to-black/30 animate-gradient-move" />
        {/* Vignette for even darker edges */}
        <div className="pointer-events-none absolute inset-0 z-10" style={{background: 'radial-gradient(ellipse at center, transparent 30%, black 100%)'}} />
      </div>
